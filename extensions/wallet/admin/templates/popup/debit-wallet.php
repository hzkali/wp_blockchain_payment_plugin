    ...
    <table class="woo-wide-form">
        <tr>
            <td>
                ...
                <div class="input-box">
                    <div class="label">
                        <span><?php echo esc_html__('Full Name', 'wooznd-smartpack'); ?></span>
                    </div>
                    <div class="input text-box">
                ...
                <div class="input-box">
                    ...
                    <div class="input select-box">
                        <select name="transtype">
                            <option value="<?php echo WOOZND_WALLET_TRANSANCTION_DEBIT; ?>"><?php echo esc_html__('Debit', 'wooznd-smartpack'); ?></option>                
                            <option value="<?php echo WOOZND_WALLET_TRANSANCTION_WITHDRAWAL; ?>"><?php echo esc_html__('Withdrawal', 'wooznd-smartpack'); ?></option>
                            <option value="<?php echo WOOZND_WALLET_TRANSANCTION_PAYMENT; ?>"><?php echo esc_html__('Payment', 'wooznd-smartpack'); ?></option>
                            <option value="<?php echo WOOZND_WALLET_TRANSANCTION_BILL; ?>"><?php echo esc_html__('Bill', 'wooznd-smartpack'); ?></option>                
