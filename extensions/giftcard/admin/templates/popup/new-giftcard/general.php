    ...
    <tr>
        <td>
            <div class="input-box">
                ...
                <div class="input select-box">
                    <select name="discount_type">                            
                        ...
                        <option value="fixed_product"><?php echo esc_html__('Product Discount', 'wooznd-smartpack'); ?></option>
                    </select>
                </div>
            </div>            
            <div class="input-box">
                ...
                <div class="input text-box">
                    <input type="text" disabled="disabled" placeholder="<?php echo esc_html__('Auto Generate', 'wooznd-smartpack'); ?>">
                </div>
            </div>          
            <div class="input-box">
                <div class="label">
                ...
                <div class="input text-box">
                    <input name="amount" type="number" min="0" step="0.05" value="20.00" placeholder="0.00">
                </div>
            </div>
            <div class="input-box last">
                ...
                <div class="input text-box">
                    <input name="coupon_amount" type="number" min="0" step="0.05" value="20.00" placeholder="0.00">
                </div>
            </div>
        ...
        <td class="wide-second">
            <div class="input-box">
                ...
                <div class="input check-box">
                    ...
                    <input id="apply_before_tax" name="apply_before_tax" value="yes" type="checkbox" />
            ...
            <div class="input-box">
                ...
                <div class="input text-box">
                    <input name="send_date" type="text" class="pop_datepicker" value="<?php ?>" placeholder="Event Date">
                </div>
            </div>
            ...
            <div class="input-box last">
                ...
                <div class="input text-box">
                    <input name="expiry_date" type="text" class="pop_datepicker" value="" placeholder="Expiry Date">
                </div>
            </div>
        </td>
    </tr>
