    ...
    <tr>
        <td>
            <div class="input-box">
                ...
                <div class="input text-box">
                    <input name="minimum_amount" type="number" min="0" step="0.05" placeholder="<?php echo esc_html__('No Minimum', 'wooznd-smartpack') ?>">
                </div>
            </div>
            <div class="input-box">
                <div class="label">
                ...
                <div class="input text-box">
                    <input name="maximum_amount" type="number" min="0" step="0.05" placeholder="<?php echo esc_html__('No Maximum', 'wooznd-smartpack') ?>">
                </div>
            </div>
        ...
        <td class="wide-second">
            ...
            <div class="input-box">
                ...
                <div class="input text-box">
                    <input name="usage_limit_per_user" type="number" min="0" step="1" placeholder="<?php echo esc_html__('Unlimited Usage', 'wooznd-smartpack') ?>">
                </div>
            </div>
            ...
            <div class="input-box last">
                ...
                <div class="input text-box">
                    <input name="usage_limit" type="number" min="0" step="1" placeholder="<?php echo esc_html__('Unlimited Usage', 'wooznd-smartpack') ?>">
                </div>
            </div>
        </td>
    </tr>
